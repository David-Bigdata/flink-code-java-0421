...
public class HighLowTempPerWindow {
    ...
    private static class WindowResult extends ProcessWindowFunction<Tuple3<String, Double, Double>, HighLowTemp, String, TimeWindow> {
        @Override
    ...
    private static class Agg implements AggregateFunction<SensorReading, Tuple3<String, Double, Double>,Tuple3<String, Double, Double>> {
